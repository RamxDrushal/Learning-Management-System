                            ...
                            <div class="span12">
                                <form action="read.php" method="post">
                                    <?php if(isset($not_read) && $not_read == '0') {
                                        // Handle case when $not_read is defined and is 0
                                    } else { ?>
                                    ...
                                    if ($count  > 0){
                                        $yes = ''; // Initialize $yes outside the loop
                                        while($row = mysqli_fetch_array($query)){
                                            ...
                                            if ($read_row !== null) {
                                                ...
                                                // Handle the case when $read_row is null
                                                $yes = ''; // Default value when $read_row is null
                                            }
                                    ?>
                                            <div class="post"  id="del<?php echo $id; ?>">
                                                <?php if ($yes == 'yes') {
                                                    // Handle case when $yes is 'yes'
                                                } else { ?>

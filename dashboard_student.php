                                ...
                                <div class="span12">
  										...
  										<ul	 id="da-thumbs" class="da-thumbs">
											...
											<li>
												...
												<p class="subject"><?php echo $row['subject_code']; ?></p>
												<p class="subject"><?php echo $row['firstname']." ".$row['lastname']?></p>
												<p><a href="enroll.php<?php echo '?id='.$id; ?>&&<?php echo 'studentid='.$session_id; ?>&&<?php echo 'teacherid='.$teacherid; ?>">Enroll</a></p>
									...
									<?php }}else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> You are currently enrolled all class</div>
									<?php } ?>	
									</ul>

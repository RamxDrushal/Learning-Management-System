<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a href="add_downloadable.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add lessons</a></li> 
		<li class=""><a href="add_announcement.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add_Announcement</a></li> 
